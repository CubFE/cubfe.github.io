...
<span class="hljs-keyword">import</span> { <span class="hljs-title class_">ConfigProvider</span> } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;@cubui/cubui-taro&#39;</span>;
...
`)])],-1),g=n(`<h3>主题定制</h3><p><code class="">cubui</code> 组件可以通过 <a href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/Using_CSS_custom_properties">CSS 变量</a> 来组织样式，通过覆盖这些 <code class="">CSS</code> 变量，可以实现定制主题、动态切换主题等功能。</p><h4>示例</h4><p>这些变量的默认值被定义在 <code class="">page</code> 节点上，如果要转 <code class="">H5</code>，默认值被定义在 <code class="">:root</code> 节点上</p><pre><code class="language-css"><span class="hljs-selector-pseudo">:root</span>,
page {
...
`)]),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"script"),s(">")]),s(`
`)])],-1),u=n(`<h3>主题变量</h3><h4>基础变量</h4><p><code class="">cubui</code> 中的 <code class="">CSS</code> 变量分为 <strong>基础变量</strong> 和 <strong>组件变量</strong>。组件变量会继承基础变量，因此在修改基础变量后，会影响所有相关的组件。</p><h4>修改变量</h4><ul><li><p>基础变量中的主色调需要您使用十六进制色值来进行覆盖，请勿使用类似于 <code class="">red</code>,<code class="">green</code> 来进行覆盖</p></li><li><p>基础变量和组件变量都能通过 <code class="">:root，page 选择器</code>和 <code class="">ConfigProvider 组件</code>，推荐您使用 <code class="">ConfigProvider 组件</code> 来修改主色调，因为部分组件的变量激活色的渐变色使用的是 <code class="">rgba</code>，使用 <code class="">:root，page 选择器</code> 修改主色调会有部分组件变量不生效：</p></li></ul><pre><code class="language-less"><span class="hljs-comment">// 如果您仍旧选择使用:root 选择器来进行修改主色调，您还需要修改以下3个组件变量色  primaryColor为设置的主色调</span>
