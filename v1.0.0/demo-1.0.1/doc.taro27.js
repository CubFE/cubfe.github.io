import{d,r as c,b as l,k as r,w as p,aq as a,o as h,e as t,l as s}from"./style_icon.js";const o={class:"markdown-body"},i=a(`<h1>Ecard 电子卡</h1><h3>介绍</h3><p>虚拟电子卡选择</p><h3>安装</h3><pre><code class="language-javascript"><span class="hljs-keyword">import</span> { createApp } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>;
<span class="hljs-keyword">import</span> { <span class="hljs-title class_">Ecard</span> } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;@cubui/cubui-taro&#39;</span>;
...
`),t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"script"),s(">")]),t("span",{class:"language-javascript"},[s(`
  ...
  `),t("span",{class:"hljs-keyword"},"export"),s(),t("span",{class:"hljs-keyword"},"default"),s(` {
    `),t("span",{class:"hljs-title function_"},"setup"),s("("),t("span",{class:"hljs-params"}),s(`) {
      ...
      `),t("span",{class:"hljs-keyword"},"const"),s(" money = "),t("span",{class:"hljs-title function_"},"ref"),s("("),t("span",{class:"hljs-number"},"0"),s(`);
