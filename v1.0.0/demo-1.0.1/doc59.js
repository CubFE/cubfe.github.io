...
<span class="hljs-keyword">import</span> { <span class="hljs-title class_">Radio</span>, <span class="hljs-title class_">RadioGroup</span> } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;@cubui/cubui&#39;</span>;
...
`)]),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"script"),s(">")]),s(`
`)])],-1),y=a("h3",null,"自定义图标",-1),f=a("p",null,[s("通过 "),a("code",{class:""},"slot"),s(" 自定义图标，建议同时设置"),a("code",{class:""},"icon"),s("和"),a("code",{class:""},"checkedIcon"),s("两个插槽")],-1),k=a("pre",null,[a("code",{class:"language-html"},[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
...
`)]),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"script"),s(">")]),s(`
`)])],-1),I=a("h3",null,"触发 change 事件",-1),v=a("pre",null,[a("code",{class:"language-html"},[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
